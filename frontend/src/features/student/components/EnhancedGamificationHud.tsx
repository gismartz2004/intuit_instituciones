...
import { Trophy, Star, Zap, TrendingUp, ChevronUp, ChevronDown, Minimize2 } from 'lucide-react';
...
export default function EnhancedGamificationHud({ state, className }: EnhancedGamificationHudProps) {
    ...
    return (
        <div className={cn("fixed top-28 right-6 z-40 transition-all duration-300", className)}>
            <motion.div
                initial={false}
                animate={{ width: isExpanded ? '320px' : 'auto' }}
                className="relative"
            >
                <Card
                    className={cn(
                ...
                >
                    <CardContent className="p-0">
                        ...
                        <div className={cn(
                            ...
                            <div className={cn(
                                "w-10 h-10 rounded-full flex items-center justify-center font-black text-white shadow-lg flex-shrink-0",
                            ...
                            {!isExpanded ? (
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-xs text-slate-500 font-medium">{state.points} ITP</span>
                                </div>
                            ) : (
